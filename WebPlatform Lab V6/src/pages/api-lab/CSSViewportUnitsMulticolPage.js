...
export class CSSViewportUnitsMulticolPage extends Page {
  ...
  _renderCard1() {
    ...
    return h(Card, {
      ...
      s.viewportInfo ? h('pre', { class: 'code-block mt-md' }, s.viewportInfo) : null,
    );
  }
  ...
  _renderCard2() {
    ...
    return h(Card, {
      ...
      s.containerInfo ? h('pre', { class: 'code-block mt-md' }, s.containerInfo) : null,
    );
  }
  ...
  _renderCard3() {
    ...
    return h(Card, {
      ...
      s.multicolDemoHtml ? h('div', { class: 'mt-md' }, s.multicolDemoHtml) : null,
      s.multicolInfo ? h('pre', { class: 'code-block mt-md' }, s.multicolInfo) : null,
    );
  }
  ...
  _renderCard4() {
    ...
    return h(Card, {
      ...
      s.sizingInfo ? h('pre', { class: 'code-block mt-md' }, s.sizingInfo) : null,
    );
  }
