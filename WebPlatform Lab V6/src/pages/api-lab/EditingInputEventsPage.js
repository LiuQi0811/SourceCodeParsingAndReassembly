...
export class EditingInputEventsPage extends Page {
  ...
  componentWillUnmount() {
    ...
    const q = (sel) => { try { return this.el ? this.el.querySelector(sel) : null; } catch { return null; } };
  ...
  _demoExecUndoRedo() {
    ...
    try { undoResult = String(document.execCommand('undo', false, null)); } catch (e) { undoResult = `异常：${e.name}`; }
    try { redoResult = String(document.execCommand('redo', false, null)); } catch (e) { redoResult = `异常：${e.name}`; }
