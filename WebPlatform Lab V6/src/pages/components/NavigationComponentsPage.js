...
export class NavigationComponentsPage extends Page {
  ...
  renderPage() {
    ...
    const rateCard = new Card({
      ...
      children: [
        h('div', { class: 'demo-row' },
          ...
          h(Rate, { value: this.state.rateValue, allowHalf: true, onChange: (v) => { this.setState({ rateValue: v }); message.info(`评分：${v} 星`) } }),
    ...
    const sliderCard = new Card({
      ...
      children: [
        h('div', { class: 'mb-md' },
          h(Slider, { value: this.state.sliderValue, min: 0, max: 100, onChange: (v) => this.setState({ sliderValue: v }) }),
        ),
        h('div', { class: 'mb-md' },
          h(Slider, { value: this.state.sliderValue, showInput: true, onChange: (v) => this.setState({ sliderValue: v }) }),
        ),
