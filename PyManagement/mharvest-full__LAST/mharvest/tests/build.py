...
<!-- 14. blob / MSE 视频专区：纯 HTTP 抓不到，需要浏览器后端 -->
<h2>blob / MSE 视频（纯 HTTP 抓不全）</h2>
<p><a href="/mse_simple.html">MSE 播放器 · 版本一（分片地址硬编码在 JS 里）</a></p>
<p><a href="/mse_api.html">MSE 播放器 · 版本二（分片地址由接口动态返回）</a></p>
<p>这两个页面的 video.src 都是 blob: 地址，
需要 <code>--browser</code> 参数才能抓到完整视频。</p>
</body>
</html>
"""
