...
class ResourceMeta:
    ...
    def __init__(self, url: str, rtype: str, source: str = "dom"):
        self.url = url
        self.rtype = rtype
        self.source = source  # dom / network / js_css
...
class AsyncUniversalSpider:
    ...
    async def init_browser(self):
        ...
        self.fetcher_dynamic = PlaywrightFetcher(self.page_pool, self.timeout)
