...
@scope (.article) { :scope to .comments { ... } }`)),
  ...
  _runStateDemo() {
    ...
    try {
      ...
      if (!customElements.get(elName)) {
        customElements.define(elName, class extends HTMLElement {
          constructor() {
            ...
            catch (e) { this._internals = null; } // jsdom 可能未实现 attachInternals
          }
          toggleOpen() {
      ...
      try { el.toggleOpen(); } catch (e) { /* noop */ }
