// HomePage.js —— WebPlatform Lab 首页：Hero + 特性卡片 + Canvas 仪表盘
...
export class HomePage extends Page {
  initialState() { return { typed: '', articles: [], loading: true, coverage: 0 }; }
  ...
  _startTyping() {
    ...
    this._typeTimer = setInterval(() => {
      i++;
      this.setState({ typed: TYPE_TEXT.slice(0, i) });
  ...
  _drawDonut(canvas) {
    ...
    const animate = (now) => {
      ...
      this.setState({ coverage: Math.round(value) });
