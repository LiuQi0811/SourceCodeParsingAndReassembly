...
export class Sider extends Component {
    ...
    render() {
        const { width = 200, collapsedWidth = 80, collapsible = false, theme = 'dark', reverseArrow = false, className = '', children, } = this.props;
        ...
        const kids = [
            h('div', { class: 'layout__sider-children' }, ...(Array.isArray(children) ? children : [children])),
        ];
        if (collapsible) {
