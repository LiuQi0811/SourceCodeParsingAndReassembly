...
export class Text extends Component {
    render() {
        const { type, code = false, copyable = false, italic = false, delete: deleted = false, underline = false, mark = false, strong = false, className = '', children, } = this.props;
        const classes = [
            'typography',
            'typography--text',
        ...
        if (mark)
            content = h('mark', {}, content);
        if (deleted)
            content = h('del', {}, content);
        if (strong)
