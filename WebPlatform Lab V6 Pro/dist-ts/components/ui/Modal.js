...
export class Modal extends Component {
    ...
    render() {
        ...
        const footerEl = footer === null
            ? null
            : h('div', { class: 'modal__foot' }, footer || [
        ...
        return h('div', { class: 'modal-mask', onClick: (e) => {
            ...
            style: { width: `${width}px` } }, h('div', { class: 'modal__head' }, h('span', {}, title), h('button', { type: 'button', class: 'modal__close', 'aria-label': '关闭',
            onClick: () => this.close() }, '×')), h('div', { class: 'modal__body' }, children), footerEl));
    }
    componentDidMount() {
