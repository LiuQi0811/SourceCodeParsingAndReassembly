...
export class Popconfirm extends Popover {
    ...
    render() {
        const { title, description, icon, okText = '确定', okType = 'primary', okButtonProps = {}, cancelText = '取消', cancelButtonProps = {}, placement = 'top', children, disabled, } = this.props;
        // okType 映射到 btn 修饰类
        const okClass = [
            'btn',
        ...
        }, h('div', { class: 'popconfirm__inner' }, icon && h('span', { class: 'popconfirm__icon' }, icon), h('div', { class: 'popconfirm__body' }, title && h('div', { class: 'popconfirm__title' }, title), description && h('div', { class: 'popconfirm__description' }, description))), h('div', { class: 'popconfirm__buttons' }, h('button', {
            type: 'button',
            class: cancelClass,
