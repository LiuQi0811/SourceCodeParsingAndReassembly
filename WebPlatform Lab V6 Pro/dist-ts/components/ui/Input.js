...
export class Input extends Component {
    ...
    render() {
        const { placeholder = '', disabled = false, size = 'middle', type = 'text', error = false, multiline = false, addonBefore = null, addonAfter = null, } = this.props;
        const classes = [
            'input',
        ...
        if (addonBefore || addonAfter) {
            return h('div', { class: 'input-group' }, addonBefore && h('span', { class: 'input-group__addon' }, addonBefore), inputEl, addonAfter && h('span', { class: 'input-group__addon' }, addonAfter));
        }
        return inputEl;
    }
    componentDidMount() {
