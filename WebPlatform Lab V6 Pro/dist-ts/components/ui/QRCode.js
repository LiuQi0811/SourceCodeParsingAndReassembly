...
export class QRCode extends Component {
    ...
    /** Canvas 绘制 */
    _drawCanvas(canvas) {
        const { value = '', size = 96, color = '#000', bgColor = '#fff', icon, iconSize, errorLevel = 'M', } = this.props;
    ...
    /** SVG 绘制：返回 <svg> 元素 */
    _renderSVG() {
        const { size = 96, color = '#000', bgColor = '#fff', } = this.props;
    ...
    render() {
        const { type = 'canvas', size = 96, bordered = true, errorLevel = 'M', } = this.props;
        const classes = [
            'qrcode',
