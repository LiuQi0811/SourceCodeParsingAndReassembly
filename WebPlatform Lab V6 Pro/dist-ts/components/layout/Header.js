...
export class Header extends Component {
    ...
    render() {
        ...
        }, h('div', { class: 'app-header__logo-mark' }, 'W'), h('span', {}, 'WebPlatform Lab')), h('nav', { class: 'app-header__menu' }, ...MENU.map((item) => h('a', {
        ...
        }, item.label))), h('div', { class: 'app-header__actions' }, h('a', {
