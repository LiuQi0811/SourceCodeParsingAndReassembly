...
export class CSSCascadeInheritanceDeepPage extends Page {
    ...
    componentDidMount() {
        ...
        if (!f.atLayer)
            this._addLog('warn', '@layer 不可用（Chrome 99+/Firefox 97+/Safari 15.4+）');
        if (!f.atProperty)
            this._addLog('warn', '@property 不可用（Chrome 85+/Firefox 128+/Safari 16.4+）');
        if (!f.revertLayer)
            this._addLog('warn', 'revert-layer 不可用（需 @layer 支持）');
    ...
    _renderCard1() {
        ...
        const card = new Card({
            ...
            children: [
                h('p', { class: 'fs-sm text-secondary' }, 'CSS 层叠算法 8 个阶段按优先级从高到低：Origin & Importance（!important 反转优先级）→ Context（Shadow DOM 隔离）→ Element-Attached（style 属性）→ Layers（@layer）→ Specificity（选择器权重）→ Order of Appearance（出现顺序）→ Transition/Animation → Defaulting。前三阶段决定来源，后五阶段在同来源内进一步裁决。掌握后能精准预测任意 CSS 冲突的胜出规则。'),
                h('div', { class: 'ci-demo' }, h('div', { class: 'fs-sm text-secondary' }, 'Origin & Importance 优先级矩阵（高→低）：'), h('div', { class: 'ci-origin-row' }, h('div', { class: 'ci-head' }, '优先级'), h('div', { class: 'ci-head' }, '来源'), h('div', { class: 'ci-head' }, '示例'), h('div', { class: 'ci-head' }, '说明'), h('div', {}, '1 (最高)'), h('div', {}, 'User Agent !important'), h('div', {}, ':visited 隐私'), h('div', {}, '浏览器强制'), h('div', {}, '2'), h('div', {}, 'User !important'), h('div', {}, '用户样式 !important'), h('div', {}, '扩展覆盖'), h('div', {}, '3'), h('div', {}, 'Author !important'), h('div', {}, '.x { !important }'), h('div', {}, '开发者强制'), h('div', {}, '4'), h('div', {}, 'Author animation'), h('div', {}, '@keyframes'), h('div', {}, '运行动画'), h('div', {}, '5'), h('div', {}, 'Author inline'), h('div', {}, 'style="..."'), h('div', {}, '1,0,0,0 权重'), h('div', {}, '6'), h('div', {}, 'Author @layer'), h('div', {}, '@layer x { }'), h('div', {}, '按层顺序'), h('div', {}, '7'), h('div', {}, 'Author normal'), h('div', {}, '.x { }'), h('div', {}, '未分层样式'), h('div', {}, '8'), h('div', {}, 'User normal'), h('div', {}, '用户设置'), h('div', {}, '一般低于开发者'), h('div', {}, '9'), h('div', {}, 'User Agent'), h('div', {}, '默认 h1/a'), h('div', {}, '浏览器默认'), h('div', {}, '10 (最低)'), h('div', {}, 'Defaulting'), h('div', {}, 'initial'), h('div', {}, '无规则匹配'))),
                h('div', { class: 'flex items-center gap-sm flex-wrap mt-md' }, this._btn('运行层叠算法演示', { type: 'primary', size: 'sm', onClick: () => this._runCascadeDemo() })),
                h('div', { class: 'fs-sm text-secondary' }, '演示结果：'),
                h('pre', { class: 'code-block', style: { maxHeight: '500px', overflow: 'auto' } }, h('code', {}, s.cascadeInfo || '（点击按钮查看层叠算法 8 阶段完整解析）')),
            ],
        });
    ...
    _renderCard2() {
        ...
        const card = new Card({
            ...
            children: [
                h('p', { class: 'fs-sm text-secondary' }, 'Specificity 三段式 (a, b, c)：a = ID 选择器数量，b = 类/属性/伪类数量，c = 元素/伪元素数量。通配符 *、组合器 > + ~、:not() 本身不计，但括号内参数计。:is()/:matches() 取参数中最大 specificity，:where() 始终为 (0,0,0)（设计为零权重）。内联样式 = (1,0,0,0) 比任何选择器都高。!important 不参与 specificity 计算，而是在 Origin & Importance 阶段裁决。'),
                h('div', { class: 'ci-demo' }, h('table', { class: 'ci-spec-table' }, h('thead', {}, h('tr', {}, h('th', {}, '选择器'), h('th', {}, 'a (ID)'), h('th', {}, 'b (类/属性/伪类)'), h('th', {}, 'c (元素/伪元素)'), h('th', {}, '总和'))), h('tbody', {}, h('tr', {}, h('td', {}, '*'), h('td', {}, '0'), h('td', {}, '0'), h('td', {}, '0'), h('td', {}, '0,0,0')), h('tr', {}, h('td', {}, 'div'), h('td', {}, '0'), h('td', {}, '0'), h('td', {}, '1'), h('td', {}, '0,0,1')), h('tr', {}, h('td', {}, '.item'), h('td', {}, '0'), h('td', {}, '1'), h('td', {}, '0'), h('td', {}, '0,1,0')), h('tr', {}, h('td', {}, '#nav'), h('td', {}, '1'), h('td', {}, '0'), h('td', {}, '0'), h('td', {}, '1,0,0')), h('tr', {}, h('td', {}, '#nav .item:hover a'), h('td', {}, '1'), h('td', {}, '2'), h('td', {}, '1'), h('td', {}, '1,2,1')), h('tr', {}, h('td', {}, ':where(.a, #b)'), h('td', {}, '0'), h('td', {}, '0'), h('td', {}, '0'), h('td', {}, '0,0,0')), h('tr', {}, h('td', {}, ':is(.a, #b)'), h('td', {}, '1'), h('td', {}, '0'), h('td', {}, '0'), h('td', {}, '1,0,0')), h('tr', {}, h('td', {}, 'style="..."'), h('td', {}, '1'), h('td', {}, '0'), h('td', {}, '0'), h('td', {}, '1,0,0,0'))))),
                h('div', { class: 'flex items-center gap-sm flex-wrap mt-md' }, this._btn('运行 Specificity 演示', { type: 'primary', size: 'sm', onClick: () => this._runSpecificityDemo() })),
                h('div', { class: 'fs-sm text-secondary' }, '演示结果：'),
                h('pre', { class: 'code-block', style: { maxHeight: '500px', overflow: 'auto' } }, h('code', {}, s.specificityInfo || '（点击按钮查看 Specificity 完整计算规则）')),
            ],
        });
        this.registerChild(card);
        return card.render();
    ...
    _renderCard3() {
        ...
        const card = new Card({
            ...
            children: [
                h('p', { class: 'fs-sm text-secondary' }, '继承让父元素的可继承属性（color/font-*/text-*/line-height/visibility/cursor/list-style/direction 等）自动传递给所有后代。不可继承属性（border/margin/padding/width/height/background/display/position 等）则不会传递。控制继承的关键字：inherit 强制继承 / initial 重置为规范初始值 / unset 可继承属性等同 inherit 不可继承等同 initial / revert 回退到 UA 默认 / revert-layer 回退到上一级 @layer。all 属性可同时重置所有属性。'),
                h('div', { class: 'ci-demo' }, h('div', { class: 'ci-inh-parent' }, h('div', {}, '父元素（color: #1e40af, font-family: monospace, font-size: 14px）'), h('div', { class: 'ci-inh-child-a' }, '子元素 A：未设 color/font，自动继承父元素'), h('div', { class: 'ci-inh-child-b' }, '子元素 B：color: initial（→black）/ font-family: unset'), h('div', { class: 'ci-inh-child-c' }, '子元素 C：all: revert 全部回退到 UA 默认'))),
                h('div', { class: 'flex items-center gap-sm flex-wrap mt-md' }, this._btn('运行继承演示', { type: 'primary', size: 'sm', onClick: () => this._runInheritanceDemo() })),
                h('div', { class: 'fs-sm text-secondary' }, '演示结果：'),
                h('pre', { class: 'code-block', style: { maxHeight: '500px', overflow: 'auto' } }, h('code', {}, s.inheritanceInfo || '（点击按钮查看继承机制完整解析）')),
            ],
        });
        this.registerChild(card);
        return card.render();
    ...
    _renderCard4() {
        ...
        const card = new Card({
            ...
            children: [
                h('p', { class: 'fs-sm text-secondary' }, '@layer name { ... } 声明级联层，先声明的层优先级越高，未分层样式优先级最高（视为最后的匿名层）。@import "x.css" layer(name); 导入到指定层。revert-layer 在层内回退到上一层值。应用场景：第三方库隔离 layer(vendor)、设计系统分层 layer(reset, base, components, utilities)、覆盖第三方样式无需 !important。替代 specificity 战争的纯 CSS 方案。Chrome 99+/Firefox 97+/Safari 15.4+ 支持。'),
                h('div', { class: 'ci-demo' }, h('div', { class: 'fs-sm text-secondary' }, '层叠优先级（高→低）：'), h('div', { class: 'ci-layer-stack' }, h('div', { class: 'ci-layer-row ci-unlayered' }, '未分层样式（最高优先级，视为最后的匿名层）'), h('div', { class: 'ci-layer-row ci-l1' }, '@layer base（第 1 声明，优先级最高）'), h('div', { class: 'ci-layer-row ci-l2' }, '@layer components（第 2 声明）'), h('div', { class: 'ci-layer-row ci-l3' }, '@layer utilities（第 3 声明）'), h('div', { class: 'ci-layer-row ci-l4' }, '@layer overrides（最后声明，优先级最低）'))),
                h('div', { class: 'flex items-center gap-sm flex-wrap mt-md' }, this._btn('运行 @layer 演示', { type: 'primary', size: 'sm', onClick: () => this._runLayerDemo() })),
                h('div', { class: 'fs-sm text-secondary' }, '演示结果：'),
                h('pre', { class: 'code-block', style: { maxHeight: '500px', overflow: 'auto' } }, h('code', {}, s.layerInfo || '（点击按钮查看 @layer 完整用法）')),
            ],
        });
        this.registerChild(card);
        return card.render();
    ...
    _renderCard5() {
        ...
        const card = new Card({
            ...
            children: [
                h('p', { class: 'fs-sm text-secondary' }, 'CSS 变量：--name: value; 定义（必须以 -- 开头，区分大小写），var(--name) 或 var(--name, fallback) 使用。定义在 :root 全局可用，定义在元素上仅该元素子树可用。CSS 变量默认继承（沿 DOM 树向下）。与 Sass/Less 预处理器变量区别：CSS 变量运行时求值（可 JS 动态修改），Sass 编译时求值（不可动态修改）。不可直接用于 @media 条件，但可在 @media 内重新定义变量实现响应式。Chrome 49+/Firefox 31+/Safari 9.1+ 支持。'),
                h('div', { class: 'ci-demo' }, h('div', { class: 'ci-cp-root' }, h('div', {}, '根元素：--ci-primary: #3b82f6, --ci-spacing: 16px'), h('div', { class: 'ci-cp-child' }, '子元素：自动继承父级变量，calc(var(--ci-spacing) / 2)')), h('div', { class: 'ci-cp-theme-dark' }, '主题变体：--ci-primary: #1e40af, --ci-spacing: 20px')),
                h('div', { class: 'flex items-center gap-sm flex-wrap mt-md' }, this._btn('运行 CSS 变量演示', { type: 'primary', size: 'sm', onClick: () => this._runCustomPropDemo() })),
                h('div', { class: 'fs-sm text-secondary' }, '演示结果：'),
                h('pre', { class: 'code-block', style: { maxHeight: '500px', overflow: 'auto' } }, h('code', {}, s.customPropInfo || '（点击按钮查看 CSS 变量基础完整用法）')),
            ],
        });
        this.registerChild(card);
        return card.render();
    ...
    _renderCard6() {
        ...
        const card = new Card({
            ...
            extra: h('div', { class: 'flex gap-xs' }, ...this._caps([['var()', f.varFunction]]), h(Tag, { color: 'primary' }, '函数')),
            children: [
                h('p', { class: 'fs-sm text-secondary' }, 'var(--name, fallback) 的 fallback 在 --name 未定义或无效时使用，可以是另一个 var() 实现链式降级：var(--a, var(--b, default))。注意 --name: ;（空值）算"已定义"，fallback 不触发。var() 不能用于属性名，只能用于值。可在 calc() 中计算：calc(var(--gap) * 2)。可与 color-mix 等颜色函数配合。性能开销微小，现代浏览器优化良好。Chrome DevTools 鼠标悬浮 var() 显示当前值。'),
                h('div', { class: 'ci-var-demo' }, 'var(--ci-primary, #ccc) 链式降级：var(--a, var(--b, var(--c, default)))'),
                h('div', { class: 'flex items-center gap-sm flex-wrap mt-md' }, this._btn('运行 var() 函数演示', { type: 'primary', size: 'sm', onClick: () => this._runVarFnDemo() })),
                h('div', { class: 'fs-sm text-secondary' }, '演示结果：'),
                h('pre', { class: 'code-block', style: { maxHeight: '500px', overflow: 'auto' } }, h('code', {}, s.varFnInfo || '（点击按钮查看 var() 函数完整深潜）')),
            ],
        });
        this.registerChild(card);
        return card.render();
    ...
    _renderCard7() {
        ...
        const card = new Card({
            ...
            extra: h('div', { class: 'flex gap-xs' }, ...this._caps([['@property', f.atProperty]]), h(Tag, { color: 'primary' }, 'Houdini')),
            children: [
                h('p', { class: 'fs-sm text-secondary' }, '@property --name { syntax; inherits; initial-value; } 注册类型化自定义属性，浏览器知道类型后可平滑动画。syntax 支持 <length>/<color>/<number>/<percentage>/<angle>/<time>/<resolution>/<url>/*，多值用 + 或 # 修饰，二选用 | 分隔。inherits 控制继承。initial-value 必须符合 syntax（syntax 为 * 时不可设）。注册后优势：类型安全、可动画化（未注册变量不可平滑动画）、浏览器正确插值。JS 用 CSS.registerProperty() 动态注册。Chrome 85+/Firefox 128+/Safari 16.4+ 支持。'),
                h('div', { class: 'ci-demo' }, h('div', { class: 'fs-sm text-secondary' }, '@property 注册 --ci-grad-start/--ci-grad-end 为 <color> 类型，可平滑动画渐变：'), h('div', { class: 'ci-prop-anim' })),
                h('div', { class: 'flex items-center gap-sm flex-wrap mt-md' }, this._btn('运行 @property 演示', { type: 'primary', size: 'sm', onClick: () => this._runPropertyDemo() })),
                h('div', { class: 'fs-sm text-secondary' }, '演示结果：'),
                h('pre', { class: 'code-block', style: { maxHeight: '500px', overflow: 'auto' } }, h('code', {}, s.propertyInfo || '（点击按钮查看 @property 完整用法）')),
            ],
        });
        this.registerChild(card);
        return card.render();
    ...
    _renderCard8() {
        ...
        const card = new Card({
            ...
            extra: h('div', { class: 'flex gap-xs' }, h(Tag, { color: 'primary' }, '实战'), h(Tag, { color: f.atLayer ? 'success' : 'error' }, `@layer ${f.atLayer ? '✓' : '✗'}`), h(Tag, { color: f.atProperty ? 'success' : 'error' }, `@property ${f.atProperty ? '✓' : '✗'}`)),
            children: [
                h('p', { class: 'fs-sm text-secondary' }, '完整实战模式：主题切换（light/dark，:root 变量 + [data-theme] 覆盖）/ 组件设计系统（变量分层 spacing/color/font/z-index）/ 动态计算（calc + var 响应式）/ 类型化变量动画（@property + animation 平滑过渡）/ @layer 组织大型项目（reset/base/components/utilities）/ :where() 零权重重置 / all: unset 重置第三方样式 / 继承陷阱避免。调试：Chrome DevTools Computed 查看继承链、getComputedStyle().getPropertyValue()、element.style.setProperty() 动态修改、CSS.supports() 检测。性能优化与浏览器兼容性速查。'),
                h('div', { class: 'flex items-center gap-sm flex-wrap' }, this._btn('运行实战模式演示', { type: 'primary', size: 'sm', onClick: () => this._runPatternDemo() })),
                h('div', { class: 'fs-sm text-secondary' }, '演示结果：'),
                h('pre', { class: 'code-block', style: { maxHeight: '600px', overflow: 'auto' } }, h('code', {}, s.patternInfo || '（点击按钮查看实战模式与调试技巧完整代码）')),
            ],
        });
        this.registerChild(card);
        return card.render();
...
//# sourceMappingURL=CSSCascadeInheritanceDeepPage.js.map