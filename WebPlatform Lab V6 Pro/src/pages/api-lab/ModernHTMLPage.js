...
export class ModernHTMLPage extends Page {
  ...
  _renderCard1() {
    ...
    return h(Card, {
      ...
      s.untilFoundState ? h('p', { class: 'fs-sm mt-sm text-secondary' }, s.untilFoundState) : null,
...
// vs hidden（不可搜索） vs display:none（不占空间）`),
  ...
  _renderCard2() {
    ...
    const mk = (summary, body) => h('details', { name: 'faq', ontoggle: onToggle },
      h('summary', {}, summary),
    ...
    return h(Card, {
      ...
      s.accordionInfo ? h('p', { class: 'fs-sm mt-sm text-secondary' }, s.accordionInfo) : null,
      h('pre', { class: 'code-block mt-md' },
    ...
    return h(Card, {
      ...
      h('div', { class: 'mh-inert-stage' },
        h('div', { id: 'mh-inert-pane', class: 'mh-inert-pane' },
          ...
          h('p', {}, h('a', { href: '#', onclick: (e) => e.preventDefault() }, '一个链接')),
      ...
      s.inertState ? h('p', { class: 'fs-sm mt-sm text-secondary' }, s.inertState) : null,
      h('pre', { class: 'code-block mt-md' },
...
// 模态遮罩：<div class="backdrop" inert>背景内容</div> + <dialog>`),
  ...
  _renderCard4() {
    ...
    return h(Card, {
      ...
      s.lazyInfo ? h('p', { class: 'fs-sm mt-sm text-secondary' }, s.lazyInfo) : null,
      h('pre', { class: 'code-block mt-md' },
...
<img fetchpriority="low" src="...">   // 非关键低优先级`),
  ...
  _renderCard5() {
    ...
    return h(Card, {
      ...
      s.popoverHintState ? h('p', { class: 'fs-sm mt-sm text-secondary' }, s.popoverHintState) : null,
      h('pre', { class: 'code-block mt-md' },
    ...
    return h(Card, {
      ...
      h('dialog', {
        ...
        h('div', { class: 'flex gap-sm mt-md' },
          this._btn('关闭(returnValue=ok)', { type: 'primary', size: 'sm', onClick: () => { try { this.$('#mh-dialog')?.close('ok'); } catch { /* noop */ } } }),
        ),
      ),
      h('div', { class: 'flex items-center gap-sm flex-wrap mt-md' },
      ...
      s.dialogInfo ? h('p', { class: 'fs-sm mt-sm text-secondary' }, s.dialogInfo) : null,
      h('pre', { class: 'code-block mt-md' },
