...
export class HardwareDevicesPage extends Page {
  ...
  async _gamepadRumble() {
    ...
    try {
      ...
      this._addLog('err', `playEffect 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _hidRequest() {
    ...
    try {
      ...
      this._addLog('err', `requestDevice 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _hidList() {
    ...
    try {
      ...
      this._addLog('err', `getDevices 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _hidOpen(device) {
    ...
    try {
      ...
      this._addLog('err', `HID open 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _hidSendReport(device) {
    ...
    try {
      ...
      this._addLog('err', `sendReport 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _hidReceiveFeature(device) {
    ...
    try {
      ...
      this._addLog('err', `receiveFeatureReport 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _serialRequest() {
    ...
    try {
      ...
      this._addLog('err', `requestPort 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _serialOpen() {
    ...
    try {
      ...
      this._addLog('err', `port.open 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _serialWrite() {
    ...
    try {
      ...
      this._addLog('err', `port.write 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _serialRead() {
    ...
    try {
      ...
      this._addLog('err', `port.read 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _usbOpen(device) {
    ...
    try {
      ...
      this._addLog('err', `USB open 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _usbTransfer(device) {
    ...
    try {
      ...
      this._addLog('err', `USB transfer 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _btConnectGatt() {
    ...
    try {
      ...
      this._addLog('err', `GATT 操作失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  _btDisconnect() {
    ...
    try {
      ...
      this._addLog('err', `gatt.disconnect 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _nfcScan() {
    ...
    try {
      ...
      this._addLog('err', `NFC scan 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
  ...
  async _nfcWrite() {
    ...
    try {
      ...
      this._addLog('err', `NFC write 失败：${errInfo(err).name || 'Error'} — ${errInfo(err).message || ''}`);
    }
  }
