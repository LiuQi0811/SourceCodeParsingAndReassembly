// WebComponentsPage.js —— Web Components 实验室
    ...
    return [
      ...
      h(Card, {
        ...
        h('div', { class: 'log-panel mt-sm', style: { maxHeight: '140px' } },
          ...this.state.counterLog.map((l) => h('div', { class: 'log-panel__line' },
      ...
      h(Card, {
        ...
        h('div', { class: 'log-panel mt-sm', style: { maxHeight: '140px' } },
          ...this.state.shadowLog.map((l) => h('div', { class: 'log-panel__line' },
            h('span', { class: 'log-panel__time' }, l.time),
      ...
      h(Card, {
        ...
        h('div', { class: 'log-panel mt-sm', style: { maxHeight: '160px' } },
          ...this.state.lifecycleLogs.map((l) => h('div', { class: 'log-panel__line' },
            h('span', { class: 'log-panel__time' }, l.time),
