...
export class WorkerAdvancedPage extends Page {
  ...
  _demoDedicatedMock() {
    ...
    try {
      const mockWorker = {
        ...
        onerror: null,
        onmessageerror: null,
        postMessage(_msg, _transfer) { /* mock：仅演示签名 */ },
        terminate() { /* mock */ },
      };
  ...
  _demoTransferControl() {
    ...
    try {
      ...
      this.setState({ offscreenInfo:
        ...
        `  document.createElement('canvas') → canvas（${canvas.width}x${canvas.height}）\n` +
  ...
  _detectWorkerGlobal() {
    this.setState({ globalScopeInfo:
      ...
      `  typeof importScripts = ${typeof importScripts}；typeof caches = ${typeof caches}；typeof clients = ${typeof clients}\n` +
