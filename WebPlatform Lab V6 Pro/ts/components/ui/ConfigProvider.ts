...
export interface ConfigProviderProps extends Props {
  theme?: ThemeProp;
  direction?: 'ltr' | 'rtl';
  prefixCls?: string;
  componentSize?: 'small' | 'middle' | 'large';
  locale?: string | LocaleProp;
...
export class ConfigProvider extends Component {
  declare props: ConfigProviderProps;
  ...
  _applyTheme(): void {
    ...
    if (prefixCls) (this.el as Element | null)?.setAttribute('data-prefix-cls', prefixCls);
  }
