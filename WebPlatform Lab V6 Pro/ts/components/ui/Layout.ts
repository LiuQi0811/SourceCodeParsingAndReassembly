// Layout.ts —— 布局容器组件（Layout/Header/Content/Footer/Sider）
...
export class Layout extends Component {
  ...
  declare static Header: typeof Header;
  declare static Content: typeof Content;
  declare static Footer: typeof Footer;
  declare static Sider: typeof Sider;
...
export interface SiderProps extends Props {
  width?: number;
...
export interface SiderState extends State {
  collapsed: boolean;
}

/** 侧边栏：支持 width/collapsible/collapsed/onCollapse */
export class Sider extends Component {
  declare props: SiderProps;
  declare state: SiderState;

  initialState(): SiderState {
