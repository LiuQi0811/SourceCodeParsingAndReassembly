...
export interface BasicComponentsPageProps extends Props {}

export interface BasicComponentsPageState extends State {}

export class BasicComponentsPage extends Page {
  declare props: BasicComponentsPageProps;
  declare state: BasicComponentsPageState;
