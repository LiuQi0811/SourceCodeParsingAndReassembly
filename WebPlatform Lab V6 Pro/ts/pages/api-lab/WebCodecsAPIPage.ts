...
interface WebCodecsAPIPageState extends State {
  logs: any;
  capsSummary: any;
  overviewInfo: any;
...
export class WebCodecsAPIPage extends Page {
  declare state: WebCodecsAPIPageState;
  _audioCodec!: any;
  _audioDecoders!: any;
  _audioEncoders!: any;
  _decoderCodec!: any;
  ...
  _flags() {
    ...
    return {
      ...
      isTypeSupported: safe(() => typeof (VideoEncoder as any).isTypeSupported === 'function'),
    };
  }
  ...
  async _runVideoEncoderDemo() {
    ...
    if (f.isTypeSupported) {
      try {
        const ok = (VideoEncoder as any).isTypeSupported(this._probeCodec);
