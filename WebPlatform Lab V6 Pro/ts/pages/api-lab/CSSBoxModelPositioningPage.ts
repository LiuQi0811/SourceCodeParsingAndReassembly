...
interface CSSBoxModelPositioningPageCaps {
  css: boolean;
  supports: boolean;
  boxSizing: boolean;
...
export interface CSSBoxModelPositioningPageProps extends Props {}

export interface CSSBoxModelPositioningPageState extends State {
  logs: LogEntry[];
  capsSummary: string;
  boxSizingInfo: string;
  positionInfo: string;
  stickyInfo: string;
  position: string;
  marginCollapseInfo: string;
  bfcInfo: string;
  floatInfo: string;
  zIndexInfo: string;
  patternInfo: string;
  blockAlignContentInfo: string;
}

export class CSSBoxModelPositioningPage extends Page {
  declare props: CSSBoxModelPositioningPageProps;
  declare state: CSSBoxModelPositioningPageState;
  ...
  initialState(): CSSBoxModelPositioningPageState {
    return {
      logs: [],
      capsSummary: '',
  ...
  _flags(): CSSBoxModelPositioningPageCaps {
  ...
  _runBlockAlignContentDemo(): void {
    const f = this._flags();
