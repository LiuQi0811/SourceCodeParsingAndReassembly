...
interface CSSClipPathDeepPageCaps {
  css: boolean;
  supports: boolean;
  circle: boolean;
  ellipse: boolean;
...
export interface CSSClipPathDeepPageProps extends Props {}

export interface CSSClipPathDeepPageState extends State {
  logs: LogEntry[];
  capsSummary: string;
  overviewInfo: string;
  circleInfo: string;
  ...
  polygonInfo: string;
  pathInfo: string;
  geometryBoxInfo: string;
  svgClipInfo: string;
  patternInfo: string;
  objectViewBoxInfo: string;
}

export class CSSClipPathDeepPage extends Page {
  declare props: CSSClipPathDeepPageProps;
  declare state: CSSClipPathDeepPageState;
  ...
  initialState(): CSSClipPathDeepPageState {
    return {
      logs: [],
      capsSummary: '',
  ...
  _flags(): CSSClipPathDeepPageCaps {
