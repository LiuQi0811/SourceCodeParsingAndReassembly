...
interface CSSHoudiniWorkletsDeepPageCaps {
  css: boolean;
  layoutWorklet: boolean;
  animationWorklet: boolean;
  paintWorklet: boolean;
  workletAnimation: boolean;
  scrollTimeline: boolean;
  viewTimeline: boolean;
}

export interface CSSHoudiniWorkletsDeepPageProps extends Props {}

export interface CSSHoudiniWorkletsDeepPageState extends State {
  logs: LogEntry[];
  capsSummary: string;
  overviewInfo: string;
  layoutBasicInfo: string;
  layoutMethodInfo: string;
  layoutMasonryInfo: string;
  animBasicInfo: string;
  animMethodInfo: string;
  animParallaxInfo: string;
  debugInfo: string;
}

export class CSSHoudiniWorkletsDeepPage extends Page {
  declare props: CSSHoudiniWorkletsDeepPageProps;
  declare state: CSSHoudiniWorkletsDeepPageState;
  ...
  initialState(): CSSHoudiniWorkletsDeepPageState {
    return {
      logs: [],
      capsSummary: '',
  ...
  _flags(): CSSHoudiniWorkletsDeepPageCaps {
    ...
    return {
      css: hasCSS,
      layoutWorklet: check(() => hasCSS && typeof (CSS as any).layoutWorklet !== 'undefined' && typeof (CSS as any).layoutWorklet.addModule === 'function'),
      animationWorklet: check(() => hasCSS && typeof (CSS as any).animationWorklet !== 'undefined' && typeof (CSS as any).animationWorklet.addModule === 'function'),
      paintWorklet: check(() => hasCSS && typeof (CSS as any).paintWorklet !== 'undefined' && typeof (CSS as any).paintWorklet.addModule === 'function'),
