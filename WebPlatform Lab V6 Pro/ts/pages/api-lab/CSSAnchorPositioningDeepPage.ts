...
interface CSSAnchorPositioningDeepPageCaps {
  css: boolean;
  supports: boolean;
  anchorName: boolean;
  ...
  positionTryOrder: boolean;
  positionTryRule: boolean;
  positionVisibility: boolean;
  popover: boolean;
}

export interface CSSAnchorPositioningDeepPageProps extends Props {}

export interface CSSAnchorPositioningDeepPageState extends State {
  logs: LogEntry[];
  capsSummary: string;
  basicsInfo: string;
  anchorFnInfo: string;
  anchorSizeInfo: string;
  positionAreaInfo: string;
  tryFallbacksInfo: string;
  positionTryRuleInfo: string;
  visibilityInfo: string;
  patternInfo: string;
}

export class CSSAnchorPositioningDeepPage extends Page {
  declare props: CSSAnchorPositioningDeepPageProps;
  declare state: CSSAnchorPositioningDeepPageState;
  ...
  initialState(): CSSAnchorPositioningDeepPageState {
    return {
      logs: [],
      capsSummary: '',
  ...
  _flags(): CSSAnchorPositioningDeepPageCaps {
