...
interface ComputePressureAPIPageState extends State {
  logs: any;
  capsSummary: any;
  overviewInfo: any;
  observerInfo: any;
...
export class ComputePressureAPIPage extends Page {
  declare state: ComputePressureAPIPageState;
  _currentSource!: any;
  _currentState!: any;
  ...
  _flags() {
    ...
    return {
      ...
      pressureRecord: safe(() => typeof (window as any).PressureRecord !== 'undefined'),
      observeMethod: safe(() => {
        try {
