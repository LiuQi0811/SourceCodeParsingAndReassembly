...
interface CSSScrollDrivenAnimationsDeepPageCaps {
  css: boolean;
  supports: boolean;
  animationTimeline: boolean;
  animationTimelineView: boolean;
  scrollTimelineName: boolean;
  viewTimelineName: boolean;
  timelineScope: boolean;
  animationRange: boolean;
  viewTimelineInset: boolean;
  prefersReducedMotion: boolean;
}

export interface CSSScrollDrivenAnimationsDeepPageProps extends Props {}

export interface CSSScrollDrivenAnimationsDeepPageState extends State {
  logs: LogEntry[];
  capsSummary: string;
  overviewInfo: string;
  scrollInfo: string;
...
export class CSSScrollDrivenAnimationsDeepPage extends Page {
  declare props: CSSScrollDrivenAnimationsDeepPageProps;
  declare state: CSSScrollDrivenAnimationsDeepPageState;
  ...
  initialState(): CSSScrollDrivenAnimationsDeepPageState {
    return {
      logs: [],
      capsSummary: '',
  ...
  _flags(): CSSScrollDrivenAnimationsDeepPageCaps {
