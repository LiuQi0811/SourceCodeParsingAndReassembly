...
export class CSSFormColorPage extends Page {
  ...
  _renderCard1() {
    ...
    return h(Card, {
      ...
      h('form', { id: 'fc-form', class: 'fc-form', onsubmit: (e) => e.preventDefault() },
        h('div', {},
          h('input', {
      ...
      s.userValidInfo ? h('p', { class: 'fs-sm mt-sm text-secondary' }, s.userValidInfo) : null,
  ...
  _renderCard2() {
    ...
    return h(Card, {
      ...
      h('div', { class: 'fc-link-list' },
        h('a', { id: 'fc-link-offset-2', class: 'fc-link offset-2', href: '#', onclick: (e) => e.preventDefault() }, 'offset:2px（贴近基线）testing glyphs g y p'),
        h('a', { id: 'fc-link-offset-5', class: 'fc-link offset-5', href: '#', onclick: (e) => e.preventDefault() }, 'offset:5px（远离基线，避开下行字母）g y p'),
        h('a', { id: 'fc-link-thick-3', class: 'fc-link thick-3', href: '#', onclick: (e) => e.preventDefault() }, 'thickness:3px + offset:4px（粗下划线）g y p'),
        h('a', { id: 'fc-link-skip-none', class: 'fc-link skip-ink-none', href: '#', onclick: (e) => e.preventDefault() }, 'skip-ink:none（下划线穿过 g y p 连续）'),
        h('a', { id: 'fc-link-skip-all', class: 'fc-link skip-ink-all', href: '#', onclick: (e) => e.preventDefault() }, 'skip-ink:all（下划线在 g y p 处全部断开）'),
      ),
      h('div', { class: 'flex items-center gap-sm flex-wrap mt-md' },
      ...
      s.underlineInfo ? h('pre', { class: 'code-block mt-md', style: { maxHeight: '240px', overflow: 'auto' } }, s.underlineInfo) : null,
      h('pre', { class: 'code-block mt-md' },
`a { text-decoration: underline;
  ...
  _renderCard3() {
    ...
    return h(Card, {
      ...
      s.containInfo ? h('p', { class: 'fs-sm mt-sm text-secondary' }, s.containInfo) : null,
      h('pre', { class: 'code-block mt-md' },
...
/* 是 content-visibility:auto 生效前提 */`),
  ...
  _renderCard4() {
    ...
    return h(Card, {
      ...
      s.colorFnInfo ? h('pre', { class: 'code-block mt-md', style: { maxHeight: '280px', overflow: 'auto' } }, s.colorFnInfo) : null,
      h('pre', { class: 'code-block mt-md' },
...
linear-gradient(in oklch, red, blue)                /* 渐变插值色彩空间 */`),
  ...
  _renderCard5() {
    ...
    return h(Card, {
      ...
      s.colorMixInfo ? h('pre', { class: 'code-block mt-md', style: { maxHeight: '300px', overflow: 'auto' } }, s.colorMixInfo) : null,
      h('pre', { class: 'code-block mt-md' },
...
/* 相对颜色用 from 关键字 + calc 改通道 */`),
  ...
  _renderCard6() {
    ...
    return h(Card, {
      ...
      s.schemeInfo ? h('pre', { class: 'code-block mt-md', style: { maxHeight: '300px', overflow: 'auto' } }, s.schemeInfo) : null,
      h('pre', { class: 'code-block mt-md' },
